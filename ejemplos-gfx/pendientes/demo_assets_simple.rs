...
fn main() {
    ...
    loop {
        ...
        if click {
            // Tank
            if mouse_x >= tank_x as i32
                && mouse_x <= (tank_x + tank_ancho as f32) as i32
                && mouse_y >= tank_y as i32
                && mouse_y <= (tank_y + tank_alto as f32) as i32
            {
            ...
            // Crate
            if mouse_x >= crate_x as i32
                && mouse_x <= (crate_x + crate_ancho as f32) as i32
                && mouse_y >= crate_y as i32
                && mouse_y <= (crate_y + crate_alto as f32) as i32
            {
            ...
            // Platform
            if mouse_x >= platform_x as i32
                && mouse_x <= (platform_x + platform_ancho as f32) as i32
                && mouse_y >= platform_y as i32
                && mouse_y <= (platform_y + platform_alto as f32) as i32
            {
        ...
        gfx.draw_circle(
            (tank_x + tank_ancho as f32 / 2.0) as i32,
            (tank_y + tank_alto as f32 / 2.0) as i32,
            8,
            ColorRydit::Verde,
        );
        ...
        gfx.draw_text(
            &format!("Arrastrando: {:?}", arrastrando),
            20,
            130,
            16,
            ColorRydit::Magenta,
        ...
        gfx.draw_text(
            &format!("Crate: ({:.0}, {:.0})", crate_x, crate_y),
            20,
            185,
            14,
            ColorRydit::Naranja,
        ...
        gfx.draw_text(
            &format!("Platform: ({:.0}, {:.0})", platform_x, platform_y),
            20,
            210,
            14,
            ColorRydit::Gris,
        ...
        gfx.draw_text(
            "Click=Arrastrar | R=Reset | ESC=Salir",
            20,
            690,
            16,
            ColorRydit::Gris,
