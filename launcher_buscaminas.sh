...
# ============================================================================
# 🛡️ RyDit - Launcher: Buscaminas
# Pipeline: Zink + DRI3 + OpenGL ES → Termux-X11 (:0)
#
# Grid 16x16 con 40 minas
# Click izq: Revelar | Click der: Bandera | R: Reiniciar | ESC: Salir
# ============================================================================
...
echo -e "${CYAN}💣 RyDit - Buscaminas${NC}"
echo -e "${CYAN}========================${NC}"
...
echo -e "${GREEN}🚀 Lanzando Buscaminas...${NC}"
echo -e "${YELLOW}Click izq: Revelar | Click der: Bandera | R: Reiniciar | ESC: Salir${NC}"
echo ""

./target/release/demo_buscaminas

echo ""
echo -e "${GREEN}✅ Buscaminas cerrado${NC}"
