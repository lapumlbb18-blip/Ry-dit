...
impl Entity {
    ...
    pub fn render_with_camera_sdl2(
        ...
        let (screen_x, screen_y) = camera.apply_sdl2(self.x, self.y, screen_width, screen_height);
...
pub fn entity_set_position(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "entity::set_position() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn entity_get_position(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "entity::get_position() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn entity_set_sprite(
    ...
    if args.len() != 2 {
        return Valor::Error(
            "entity::set_sprite() requiere 2 argumentos: id, sprite_id".to_string(),
        );
    }
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "entity::set_sprite() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn entity_set_collidable(
    ...
    if args.len() != 2 {
        return Valor::Error(
            "entity::set_collidable() requiere 2 argumentos: id, collidable".to_string(),
        );
    }
    ...
    let collidable = match collidable_val {
        ...
        _ => {
            return Valor::Error(
                "entity::set_collidable() collidable debe ser bool o número".to_string(),
            )
        }
    };
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "entity::set_collidable() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn entity_is_collidable(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "entity::is_collidable() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn entity_set_active(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "entity::set_active() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn player_move_right(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "player::move_right() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn player_apply_gravity(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Texto(format!(
            "player::apply_gravity('{}') - vy={}, y={}",
            id, entity.vy, entity.y
        ))
    } else {
        Valor::Error(format!(
            "player::apply_gravity() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn player_is_grounded(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "player::is_grounded() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn player_set_health(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "player::set_health() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn player_get_health(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "player::get_health() La entidad '{}' no existe",
            id
        ))
    }
}
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        if new_health <= 0.0 {
            ...
            Valor::Texto(format!(
                ...
                id, amount, new_health
            ))
        }
    } else {
        Valor::Error(format!(
            "player::take_damage() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn enemy_set_ai_type(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "enemy::set_ai_type() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn enemy_set_patrol_points(
    ...
    if args.len() != 2 {
        return Valor::Error(
            "enemy::set_patrol_points() requiere 2 argumentos: id, points".to_string(),
        );
    }
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "enemy::set_patrol_points() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn enemy_set_detection_range(
    ...
    if args.len() != 2 {
        return Valor::Error(
            "enemy::set_detection_range() requiere 2 argumentos: id, range".to_string(),
        );
    }
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "enemy::set_detection_range() La entidad '{}' no existe",
            id
        ))
    }
}
        ...
        if let Some(player_entity) = player {
            ...
            if ai_type == "chase" || (ai_type == "patrol" && distance < detection_range) {
                ...
                return Valor::Texto(format!(
                    "enemy::update_ai('{}') - chasing player, dist={:.1}",
                    id, distance
                ));
            }
        }
...
pub fn boss_get_current_phase(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "boss::get_current_phase() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn boss_transition_to_phase(
    ...
    if args.len() != 2 {
        return Valor::Error(
            "boss::transition_to_phase() requiere 2 argumentos: id, phase".to_string(),
        );
    }
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "boss::transition_to_phase() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn boss_set_arena_bounds(
    ...
    if args.len() != 5 {
        return Valor::Error(
            "boss::set_arena_bounds() requiere 5 argumentos: id, min_x, min_y, max_x, max_y"
                .to_string(),
        );
    }
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Texto(format!(
            "boss::set_arena_bounds('{}', {}, {}, {}, {})",
            id, min_x, min_y, max_x, max_y
        ))
    } else {
        Valor::Error(format!(
            "boss::set_arena_bounds() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn collision_check_rect_rect(
    ...
    let vals: Vec<f32> = args
        .iter()
        .map(|arg| match evaluar_expr(arg, executor, funcs) {
            Valor::Num(n) => n as f32,
            _ => 0.0,
        })
        .collect();
...
pub fn collision_check(
    ...
    if let (Some(e1), Some(e2)) = (entity1, entity2) {
        ...
        let collision = e1.x < e2.x + e2.width
            && e1.x + e1.width > e2.x
            && e1.y < e2.y + e2.height
            && e1.y + e1.height > e2.y;
        Valor::Bool(collision)
...
impl Area2DManager {
    ...
    pub fn check(&self, id1: &str, id2: &str) -> Option<bool> {
        if let (Some(a1), Some(a2)) = (self.areas.get(id1), self.areas.get(id2)) {
            ...
            let collision = a1.x < a2.x + a2.width
                && a1.x + a1.width > a2.x
                && a1.y < a2.y + a2.height
                && a1.y + a1.height > a2.y;
            Some(collision)
        ...
        if let Some(area1) = self.areas.get(id) {
            for (id2, area2) in &self.areas {
                if id2 != id && area2.is_active {
                    let collision = area1.x < area2.x + area2.width
...
pub fn trap_set_trigger_range(
    ...
    if args.len() != 2 {
        return Valor::Error(
            "trap::set_trigger_range() requiere 2 argumentos: id, range".to_string(),
        );
    }
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Error(format!(
            "trap::set_trigger_range() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn trap_is_triggered(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "trap::is_triggered() La entidad '{}' no existe",
            id
        ))
    }
}
...
pub fn coin_set_type(
    ...
    if !["bronze", "silver", "gold", "gem", "diamond"].contains(&coin_type.as_str()) {
        return Valor::Error(
            "coin::set_type() usa: bronze, silver, gold, gem, diamond".to_string(),
        );
    }
...
pub fn coin_collect(
    ...
    if let Some(entity) = em_ref.get_mut(&id) {
        ...
        Valor::Texto(format!(
            "coin::collect() - '{}' recolectada (+{} coins)",
            id, value
        ))
    } else {
...
pub fn coin_is_collected(
    ...
    if let Some(entity) = em_ref.get(&id) {
        ...
        Valor::Error(format!(
            "coin::is_collected() La entidad '{}' no existe",
            id
        ))
    }
}
